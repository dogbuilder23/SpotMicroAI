...
class DadTwist(CatGait):
    ...
    def __init__(self, current_time):
        ...
        self.angles = [
            ...
            #-27,22,-27,22,  32,37,-32,-37,  -15,  10,  15, -10,    0.639, # Yaw Left # k 67, 50, -67, -50,
            #6,6,6,6,        44,44,-44,-44,    6,   6,  -6,  -6,    0.639,
            #22,-27,22,-27,  37,32,-37,-32,   10, -15, -10,  15,    0.639, # Yaw Right # k 50, 67, -50, -67,
            6,6,6,6,44,44,-44,-44,6,6,-6,-6,0.2,
            -27,22,-27,22,32,37,-32,-37,-3,67,3,-67,0.639,
            6,6,6,6,44,44,-44,-44,6,6,-6,-6,0.639,
            22,-27,22,-27,37,32,-37,-32,67,-3,-67,3,0.639,
            6,6,6,6,        44,44,-44,-44,    6,   6,  -6,  -6,    0.639,
            5,5,9,9,        29,29,-33,-33,   77,  77,  28,  28,    0.740, # Pitch Up.
            ...
            #6,6,6,6,        44,44,-44,-44,   6, 6, -6, -6, 0.437,
            -31,48,48,-31,31,51,-51,-31,30,-8,8,-30,0.437,
            6,6,6,6,44,44,-44,-44,6,6,-6,-6,0.437,
            48,-31,-31,48,51,31,-31,-51,-8,30,-30,8,0.437,
            6,6,6,6,44,44,-44,-44,6,6,-6,-6,0.437,]
