...
IDx = p.addUserDebugParameter("joy_x", 0, 256, 128)
IDy = p.addUserDebugParameter("joy_y", 0, 256, 128)
IDz = p.addUserDebugParameter("joy_z", 0, 256, 128)
IDrz = p.addUserDebugParameter("joy_rz", 0, 256, 128)
...
while True:
    ...
    joy_x = p.readUserDebugParameter(IDx)
